...
siamese_RNN.train_(data_loader=data_provider, keep_prob=0.5, weight_decay=0.05,
    learn_rate_start=0.005, learn_rate_end=0.0003, batch_size=32, n_iter=5000,
    save_model_every_n_iter=500, path_to_model='models/siamese')
